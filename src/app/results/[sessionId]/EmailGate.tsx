...
function BookingCTA() {
  return (
    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 text-center">
      <div className="inline-flex items-center justify-center w-10 h-10 rounded-xl bg-vai-navy-wash mb-4">
        <svg className="w-5 h-5 text-vai-navy" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      ...
      <a
        ...
        className="inline-block bg-vai-navy text-white text-sm font-semibold px-7 py-3 rounded-lg hover:bg-vai-navy-deep active:bg-vai-navy-deep transition-colors shadow-sm"
      >
        Book a Session
      </a>
    </div>
    ...
    <>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 mb-6">
        <div className="flex items-center gap-3 mb-5">
          <div className="inline-flex items-center justify-center w-9 h-9 rounded-lg bg-vai-navy-wash shrink-0">
            <svg className="w-4.5 h-4.5 text-vai-navy" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              <path strokeLinecap="round" strokeLinejoin="round"
        ...
        <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3">
          <div className="flex-1">
            ...
            <input
              ...
              className="w-full rounded-lg border border-gray-200 bg-gray-50 px-4 py-2.5 text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-vai-navy-mid focus:border-transparent"
              disabled={pending}
              autoComplete="email"
            />
          </div>
          <button
            type="submit"
            disabled={pending}
            className="bg-vai-navy text-white text-sm font-semibold px-6 py-2.5 rounded-lg hover:bg-vai-navy-deep active:bg-vai-navy-deep transition-colors shadow-sm disabled:opacity-60 whitespace-nowrap"
          >
